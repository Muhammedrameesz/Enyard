  ...
  return (
    <div className="font-jakarta py-16 relative">
      ...
      <section className="grid grid-cols-1 md:grid-cols-3 items-center gap-10 max-w-6xl xl:max-w-7xl mx-auto px-6 md:px-10">
        ...
        <AnimHV delay={0.5}>
        <div
          className="relative flex flex-col justify-center bg-no-repeat bg-center bg-cover  p-8 rounded-3xl gap-5 min-h-[450px]"
          style={{
        ...
        <div className="flex flex-col justify-center bg-white shadow-lg p-8 rounded-3xl gap-5 min-h-[450px]">
          ...
          <p className="text-base text-gray-600">
            ...
            CoreX adapts to your unique needs. Our flexible and scalable
            solution can be customized to fit your workflows, ensuring a perfect
            fit now and as you grow.
          </p>
          <button
            onClick={handleClick}
            className="w-fit text-base font-semibold text-red-600 group"
